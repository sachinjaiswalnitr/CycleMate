...
//   });
  ...
  const serviceStats = [
    { label: "Cycles Sold", value: context.sell },
    { label: "Cycles Bought", value: context.buy },
    { label: "Times Lent", value: context.lend },
    { label: "Times Borrowed", value: context.borr },
    { label: "Times Repaired", value: context.rep },
  ];
  ...
  const features = [
    {
      label: "Sell Cycle",
      path: "/dashboard/sell",
      icon: <FaExchangeAlt className="text-4xl mb-4" />,
    },
    {
      label: "Buy Cycle",
      path: "/dashboard/buy",
    ...
    {
      label: "Lend Cycle",
      path: "/dashboard/lend_cycle",
      icon: <FaHandHolding className="text-4xl mb-4" />,
    },
    {
      label: "Borrow Cycle",
      path: "/dashboard/borrow_cycle",
      icon: <FaBicycle className="text-4xl mb-4" />,
    },
    {
      label: "Repair Cycle",
      path: "/dashboard/repair_cycle",
      icon: <FaTools className="text-4xl mb-4" />,
    },
    {
      label: "View All Cycles",
      path: "/dashboard/view_cycle",
      icon: <FaEye className="text-4xl mb-4" />,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="relative">
            <button
              ...
              className={`group relative w-10 h-10 flex flex-col justify-center items-center transition-transform duration-300 hover:scale-105 ${
      ...
      <main className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
          {serviceStats.map((stat, idx) => (
            ...
            >
              ...
              <p className="text-3xl font-bold text-[#007C7C] mt-2">
                {stat.value}
              </p>
            </div>
          ))}
        ...
        {/* Services Section */}
        <div className="relative bg-[#007C7C] rounded-xl py-4 mb-8 overflow-hidden">
          <div className="absolute whitespace-nowrap animate-marquee text-white text-3xl font-bold px-4">
            Pedal Forward with Every Service......
          </div>
          <div className="relative h-8 text-center"></div>
        </div>
