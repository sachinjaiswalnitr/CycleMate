...
function Sell_cycle() {
  ...
  const handleFileInput = async (e) => {
    ...
    const res = await fetch(
      "https://api.cloudinary.com/v1_1/dwl4cbysu/upload",
      {
        method: "POST",
        body: data,
      }
      ...
      <div className="relative bg-[#e6f2f1] shadow-2xl rounded-3xl p-10 max-w-2xl w-full mx-auto z-10">
        ...
        <form onSubmit={handleOnSubmit} className="space-y-6">
          ...
          {[
            ...
            {
              label: "Cycle ID / Serial Number",
              name: "cycleID",
              type: "text",
              placeholder: "CYC12345",
            },
            {
              label: "Cycle Model",
              name: "cycleModel",
              type: "text",
              placeholder: "Hero Sprint 24T",
            },
            {
